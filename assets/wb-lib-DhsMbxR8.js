const __vite__mapDeps=(i,m=__vite__mapDeps,d=(m.f||(m.f=["assets/data-junior-_Ba-cGf_.js","assets/lesson-data-C47C-y_T.js","assets/react-vendor-Ds7D3P6J.js","assets/katex-Dc8nsIP1.js","assets/data-primary-CFuJxUaR.js","assets/data-senior-XTVNeMxQ.js"])))=>i.map(i=>d[i]);
import{j as J}from"./react-vendor-Ds7D3P6J.js";import{k as Q}from"./katex-Dc8nsIP1.js";const Z="modulepreload",ee=function(e){return"/"+e},R={},w=function(s,t,a){let n=Promise.resolve();if(t&&t.length>0){document.getElementsByTagName("link");const i=document.querySelector("meta[property=csp-nonce]"),r=(i==null?void 0:i.nonce)||(i==null?void 0:i.getAttribute("nonce"));n=Promise.allSettled(t.map(l=>{if(l=ee(l),l in R)return;R[l]=!0;const f=l.endsWith(".css"),x=f?'[rel="stylesheet"]':"";if(document.querySelector(`link[href="${l}"]${x}`))return;const m=document.createElement("link");if(m.rel=f?"stylesheet":Z,f||(m.as="script"),m.crossOrigin="",m.href=l,r&&m.setAttribute("nonce",r),document.head.appendChild(m),f)return new Promise((L,b)=>{m.addEventListener("load",L),m.addEventListener("error",()=>b(new Error(`Unable to preload CSS for ${l}`)))})}))}function o(i){const r=new Event("vite:preloadError",{cancelable:!0});if(r.payload=i,window.dispatchEvent(r),!r.defaultPrevented)throw i}return n.then(i=>{for(const r of i||[])r.status==="rejected"&&o(r.reason);return s().catch(o)})};function Se(e,s=3e3){const t=window;typeof t.requestIdleCallback=="function"?t.requestIdleCallback(e,{timeout:s}):window.setTimeout(e,1200)}const k={初中:221,小学:112,高中:211},se=["初中","小学","高中"],te=544,g={初中:0,小学:k.初中,高中:k.初中+k.小学},ae={初中:()=>w(()=>import("./data-junior-_Ba-cGf_.js"),__vite__mapDeps([0,1,2,3])),小学:()=>w(()=>import("./data-primary-CFuJxUaR.js"),__vite__mapDeps([4,1,2,3])),高中:()=>w(()=>import("./data-senior-XTVNeMxQ.js"),__vite__mapDeps([5,1,2,3]))};let p=new Array(te).fill(void 0);const h=new Set,E=new Map,T=new Set;function ve(){return p}function Be(){return se.reduce((e,s)=>e+(h.has(s)?k[s]:0),0)}function Le(e){return h.has(e)}function _e(e){return T.add(e),()=>{T.delete(e)}}function H(){T.forEach(e=>e())}const q=new Set;function we(e){return q.has(e)}function Ee(e){return e<k.初中?"初中":e<k.初中+k.小学?"小学":"高中"}function ne(e){const s=Math.max(1,e.packs),t=Math.floor(e.questions/s),a=e.questions%s;return{subject:e.subject,stage:e.stage,grade:e.grade,chapter:e.chapter,备课方案:"",课堂讲义:{核心知识点:e.summary,重点难点解析:"",典型例题精讲:""},课后作业:Array.from({length:s},(n,o)=>({difficulty:"基础",title:"",questions:Array.from({length:t+(o<a?1:0)},()=>({q:"",a:""}))})),课后反馈:"",...e.openClass?{openClass:{plan:"",talk:""}}:{}}}function Te(e){const s=[...p];let t=!1;for(const a of e)s[a.i]===void 0&&(s[a.i]=ne(a),q.add(a.i),t=!0);t&&(p=s,H())}async function Ce(e){if(h.has(e))return p.slice(g[e],g[e]+k[e]).filter(Boolean);const s=E.get(e);if(s)return s;const t=(async()=>{const a=await ae[e](),n=a.JUNIOR_LESSONS??a.PRIMARY_LESSONS??a.SENIOR_LESSONS??[];return h.add(e),p=[...p],n.forEach((o,i)=>{p[g[e]+i]=o,q.delete(g[e]+i)}),H(),n})();E.set(e,t);try{return await t}finally{E.delete(e)}}const ie="MFkwEwYHKoZIzj0CAQYIKoZIzj0DAQcDQgAEt0S+4zWqJpWaH6rl96/1h9pVEh2RJcJFvKSTYp/YFJcLvczbf+Hj5eVAxnV3Qp9q+qXfL/1+l1vmJH+mkk5z0A==",N="wb-member",M=e=>e.replace(/-/g,"+").replace(/_/g,"/")+"=".repeat((4-e.length%4)%4);function j(){try{const e=localStorage.getItem(N);if(!e)return null;const s=JSON.parse(e);return s&&typeof s.exp=="number"?s:null}catch{return null}}function oe(){const e=j();return!!e&&(e.exp===0||e.exp>Date.now())}function Pe(e,s){try{localStorage.setItem(N,JSON.stringify({code:e,exp:s}))}catch{}}const re=3*60*1e3,le="__try__",A="wb-try-used";function qe(){try{if(localStorage.getItem(A)==="1")return!0}catch{}try{if(sessionStorage.getItem(A)==="1")return!0}catch{}try{if(document.cookie.includes("wb-try-used=1"))return!0}catch{}return!1}function Ne(){try{localStorage.setItem(A,"1")}catch{}try{sessionStorage.setItem(A,"1")}catch{}try{document.cookie="wb-try-used=1; Max-Age=31536000; Path=/; SameSite=Lax"}catch{}}async function je(){const e=j();if(!e)return!1;const s=Date.now();if(e.exp!==0&&e.exp<=s||!e.code)return y(),!1;if(e.code===le){const a=e.exp>s&&e.exp-s<=re+5e3;return a||y(),a}const t=await ce(e.code);return!t.ok||t.exp!==e.exp?(y(),!1):!0}function y(){try{localStorage.removeItem(N)}catch{}}async function xe(){const e=Uint8Array.from(atob(ie),s=>s.charCodeAt(0));return crypto.subtle.importKey("spki",e,{name:"ECDSA",namedCurve:"P-256"},!1,["verify"])}async function ce(e){const s=(e||"").trim();if(!s.startsWith("MB-"))return{ok:!1,reason:"会员码格式不正确，请检查后重试"};const t=s.slice(3),a=t.indexOf(".");if(a<=0)return{ok:!1,reason:"会员码格式不正确，请检查后重试"};const n=t.slice(0,a),o=t.slice(a+1);try{const i=await xe(),r=Uint8Array.from(atob(M(o)),m=>m.charCodeAt(0)),l=new TextEncoder().encode(n);if(!await crypto.subtle.verify({name:"ECDSA",hash:"SHA-256"},i,r,l))return{ok:!1,reason:"会员码无效（签名校验失败）"};const x=JSON.parse(atob(M(n)));return typeof x.e!="number"?{ok:!1,reason:"会员码数据异常"}:x.e!==0&&x.e<Date.now()?{ok:!1,reason:"该会员码已过期"}:{ok:!0,exp:x.e}}catch{return{ok:!1,reason:"会员码无效（当前浏览器不支持校验，请换最新版微信/浏览器）"}}}const fe="wb-tier",Oe=3,Re=2,Me=10;function Ue(){try{return localStorage.getItem(fe)==="pro"?"pro":"free"}catch{return"free"}}const Xe=()=>oe();function Ke(){const e=j();return!e||e.exp!==0&&e.exp<=Date.now()?!1:!!e.code&&e.code!=="__try__"}function D(){const e=new Date,s=String(e.getMonth()+1).padStart(2,"0"),t=String(e.getDate()).padStart(2,"0");return`${e.getFullYear()}-${s}-${t}`}function me(){try{const e=D(),s=localStorage.getItem("wb-export-count");if(!s)return 0;const t=JSON.parse(s);if(!t||typeof t!="object"||t.date!==e)return 0;const a=Number(t.count);return Number.isFinite(a)&&a>=0?a:0}catch{return 0}}function Ie(){const e=D(),s=me()+1;try{localStorage.setItem("wb-export-count",JSON.stringify({date:e,count:s}))}catch{}return s}const ze="由「教师备课助手」免费版生成 · 开通会员解锁完整导出";function F(e){return e.replace(/\\\\([A-Za-z])/g,"\\$1").replace(/[\x08\x0B\x0C]([A-Za-z])/g,"\\$1").replace(/[\x08\x0B\x0C]/g,"")}function S(e){return String(e??"").replace(/&/g,"&amp;").replace(/</g,"&lt;").replace(/>/g,"&gt;").replace(/"/g,"&quot;").replace(/'/g,"&#39;")}function $(e){let s="",t=!1;for(let a=0;a<e.length;a++){const n=e[a];if(n==="$"){t=!t,s+=n;continue}if(!t&&n==="\\"&&e[a+1]==="n"){s+=`
`,a++;continue}s+=n}return s}function U(e){if(!e)return"";const s=F($(String(e))),t=[];let a=s.replace(/!\[([^\]]*)\]\(([^)\s]+)\)/g,(i,r,l)=>`@@IMG${t.push({alt:r,src:l})-1}@@`);const n=[];a=a.replace(/\$([^$\n]+?)\$/g,(i,r)=>`@@MATH${n.push(r.trim())-1}@@`);let o=S(a).replace(/\*\*(.+?)\*\*/g,"<strong>$1</strong>").replace(/\n/g,"<br>");return o=o.replace(/@@MATH(\d+)@@/g,(i,r)=>C(n[+r],!1)),o=o.replace(/@@IMG(\d+)@@/g,(i,r)=>{const l=t[+r];return`<img src="${l.src}" alt="${l.alt}" loading="lazy" style="max-width:100%;border-radius:8px;margin:6px 0;display:block">`}),o}function C(e,s){try{return Q.renderToString(e,{displayMode:s,throwOnError:!1,strict:!1,trust:!0,output:"html"})}catch{return s?`<div class="plain-formula">${e}</div>`:`<code class="inline-math">${e}</code>`}}function v(e){return S(e).replace(/\*\*(.+?)\*\*/g,"<strong>$1</strong>").replace(/`([^`]+)`/g,"<code>$1</code>").replace(/\n/g,"<br>")}function ke(e){const s=e.map(o=>o.replace(/^\||\|$/g,"").split("|").map(i=>i.trim())),t=s[0],a=s.slice(2);let n="<table><thead><tr>";return t.forEach(o=>{n+=`<th>${v(o)}</th>`}),n+="</tr></thead><tbody>",a.forEach(o=>{n+="<tr>",o.forEach(i=>{n+=`<td>${v(i)}</td>`}),n+="</tr>"}),'<div class="md-table-wrap">'+n+"</tbody></table></div>"}function de(e){const s=e.map(n=>{const o=n.match(/^(\s*)[-*•]\s+(.*)$/);return{level:Math.floor(((o==null?void 0:o[1].length)??0)/2),content:(o==null?void 0:o[2])??""}});let t="<ul>",a=0;for(s.forEach(n=>{for(;a>n.level;)t+="</ul>",a--;n.level>a&&(t+="<ul>",a++),t+=`<li>${v(n.content)}</li>`});a>0;)t+="</ul>",a--;return t+="</ul>",t}function u(e){if(!e)return'<p class="empty-md">（暂无内容）</p>';const s=F($(String(e))).replace(/\r\n/g,`
`),t=[];let a=s.replace(/\$\$([\s\S]+?)\$\$/g,(l,f)=>`
@@TOKEN${t.push({type:"block",tex:f.trim()})-1}@@
`);a=a.replace(/\$([^$\n]+?)\$/g,(l,f)=>`@@TOKEN${t.push({type:"inline",tex:f.trim()})-1}@@`),a=a.replace(/!\[([^\]]*)\]\(([^)]+)\)/g,(l,f,x)=>`@@TOKEN${t.push({type:"img",alt:f,src:x})-1}@@`);const n=a.split(`
`),o=[];let i=0;for(;i<n.length;){const l=n[i],f=l.trim();if(!f){i++;continue}if(f.startsWith("|")&&i+1<n.length&&/^\s*\|?[\s:|-]+\|?\s*$/.test(n[i+1])&&n[i+1].includes("-")){const m=[];for(;i<n.length&&n[i].trim().startsWith("|");)m.push(n[i].trim()),i++;o.push(ke(m));continue}if(/^\s*[-*•]\s+/.test(l)){const m=[];for(;i<n.length&&/^\s*[-*•]\s+/.test(n[i]);)m.push(n[i]),i++;o.push(de(m));continue}const x=[l];for(i++;i<n.length&&n[i].trim()&&!/^\s*[-*•]\s+/.test(n[i])&&!n[i].trim().startsWith("|");)x.push(n[i]),i++;o.push(`<p>${v(x.join(`
`))}</p>`)}let r=o.join(`
`);return r=r.replace(/@@TOKEN(\d+)@@/g,(l,f)=>{const x=t[+f];return x.type==="img"?`<img src="${S(x.src??"")}" alt="${S(x.alt??"")}" loading="lazy">`:x.type==="block"?`<div class="katex-display">${C(x.tex??"",!0)}</div>`:C(x.tex??"",!1)}),r}const He=({source:e,className:s})=>J.jsx("div",{className:`md ${s??""}`,dangerouslySetInnerHTML:{__html:u(e)}}),P={name:"hzj",wechat:"April_18forever"},De={trial:{id:"trial",name:"限时体验",price:"免费",unit:"",desc:"每台设备限一次 · 全量预览 3 分钟（导出仍带水印）"},month:{id:"month",name:"月卡会员",price:"¥9.9",unit:"/月",desc:"短期尝鲜 · 无限导出无水印 · 全部答案/作业/反馈"},year:{id:"year",name:"年卡会员",price:"¥49",unit:"/年",desc:"最受欢迎 · 无限导出无水印 · 优先更新内容",recommend:!0},forever:{id:"forever",name:"永久会员",price:"¥99",unit:"",desc:"一次购买 · 终身使用 · 含全部未来更新"}},Fe=[0,221,333];async function $e(){const e=P.wechat;try{return await navigator.clipboard.writeText(e),!0}catch{try{const s=document.createElement("textarea");s.value=e,s.style.position="fixed",s.style.opacity="0",document.body.appendChild(s),s.select();const t=document.execCommand("copy");return document.body.removeChild(s),t}catch{return!1}}}const pe='@font-face{font-display:block;font-family:KaTeX_AMS;font-style:normal;font-weight:400;src:url(/assets/KaTeX_AMS-Regular-BQhdFMY1.woff2) format("woff2")}@font-face{font-display:block;font-family:KaTeX_Caligraphic;font-style:normal;font-weight:700;src:url(/assets/KaTeX_Caligraphic-Bold-Dq_IR9rO.woff2) format("woff2")}@font-face{font-display:block;font-family:KaTeX_Caligraphic;font-style:normal;font-weight:400;src:url(/assets/KaTeX_Caligraphic-Regular-Di6jR-x-.woff2) format("woff2")}@font-face{font-display:block;font-family:KaTeX_Fraktur;font-style:normal;font-weight:700;src:url(/assets/KaTeX_Fraktur-Bold-CL6g_b3V.woff2) format("woff2")}@font-face{font-display:block;font-family:KaTeX_Fraktur;font-style:normal;font-weight:400;src:url(/assets/KaTeX_Fraktur-Regular-CTYiF6lA.woff2) format("woff2")}@font-face{font-display:block;font-family:KaTeX_Main;font-style:normal;font-weight:700;src:url(/assets/KaTeX_Main-Bold-Cx986IdX.woff2) format("woff2")}@font-face{font-display:block;font-family:KaTeX_Main;font-style:italic;font-weight:700;src:url(/assets/KaTeX_Main-BoldItalic-DxDJ3AOS.woff2) format("woff2")}@font-face{font-display:block;font-family:KaTeX_Main;font-style:italic;font-weight:400;src:url(/assets/KaTeX_Main-Italic-NWA7e6Wa.woff2) format("woff2")}@font-face{font-display:block;font-family:KaTeX_Main;font-style:normal;font-weight:400;src:url(/assets/KaTeX_Main-Regular-B22Nviop.woff2) format("woff2")}@font-face{font-display:block;font-family:KaTeX_Math;font-style:italic;font-weight:700;src:url(/assets/KaTeX_Math-BoldItalic-CZnvNsCZ.woff2) format("woff2")}@font-face{font-display:block;font-family:KaTeX_Math;font-style:italic;font-weight:400;src:url(/assets/KaTeX_Math-Italic-t53AETM-.woff2) format("woff2")}@font-face{font-display:block;font-family:KaTeX_SansSerif;font-style:normal;font-weight:700;src:url(/assets/KaTeX_SansSerif-Bold-D1sUS0GD.woff2) format("woff2")}@font-face{font-display:block;font-family:KaTeX_SansSerif;font-style:italic;font-weight:400;src:url(/assets/KaTeX_SansSerif-Italic-C3H0VqGB.woff2) format("woff2")}@font-face{font-display:block;font-family:KaTeX_SansSerif;font-style:normal;font-weight:400;src:url(/assets/KaTeX_SansSerif-Regular-DDBCnlJ7.woff2) format("woff2")}@font-face{font-display:block;font-family:KaTeX_Script;font-style:normal;font-weight:400;src:url(/assets/KaTeX_Script-Regular-D3wIWfF6.woff2) format("woff2")}@font-face{font-display:block;font-family:KaTeX_Size1;font-style:normal;font-weight:400;src:url(/assets/KaTeX_Size1-Regular-mCD8mA8B.woff2) format("woff2")}@font-face{font-display:block;font-family:KaTeX_Size2;font-style:normal;font-weight:400;src:url(/assets/KaTeX_Size2-Regular-Dy4dx90m.woff2) format("woff2")}@font-face{font-display:block;font-family:KaTeX_Size3;font-style:normal;font-weight:400;src:url(data:font/woff2;base64,) format("woff2")}@font-face{font-display:block;font-family:KaTeX_Size4;font-style:normal;font-weight:400;src:url(/assets/KaTeX_Size4-Regular-Dl5lxZxV.woff2) format("woff2")}@font-face{font-display:block;font-family:KaTeX_Typewriter;font-style:normal;font-weight:400;src:url(/assets/KaTeX_Typewriter-Regular-CO6r4hn1.woff2) format("woff2")}.katex{font: 1.21em KaTeX_Main,Times New Roman,serif;line-height:1.2;position:relative;text-indent:0;text-rendering:auto}.katex *{-ms-high-contrast-adjust:none!important;border-color:currentColor}.katex .katex-version:after{content:"0.16.47"}.katex .katex-mathml{border:0;-webkit-clip-path:inset(50%);clip-path:inset(50%);height:1px;overflow:hidden;padding:0;position:absolute;width:1px}.katex .katex-html>.newline{display:block}.katex .base{position:relative;white-space:nowrap;width:-webkit-min-content;width:-moz-min-content;width:min-content}.katex .base,.katex .strut{display:inline-block}.katex .textbf{font-weight:700}.katex .textit{font-style:italic}.katex .textrm{font-family:KaTeX_Main}.katex .textsf{font-family:KaTeX_SansSerif}.katex .texttt{font-family:KaTeX_Typewriter}.katex .mathnormal{font-family:KaTeX_Math;font-style:italic}.katex .mathit{font-family:KaTeX_Main;font-style:italic}.katex .mathrm{font-style:normal}.katex .mathbf{font-family:KaTeX_Main;font-weight:700}.katex .boldsymbol{font-family:KaTeX_Math;font-style:italic;font-weight:700}.katex .amsrm,.katex .mathbb,.katex .textbb{font-family:KaTeX_AMS}.katex .mathcal{font-family:KaTeX_Caligraphic}.katex .mathfrak,.katex .textfrak{font-family:KaTeX_Fraktur}.katex .mathboldfrak,.katex .textboldfrak{font-family:KaTeX_Fraktur;font-weight:700}.katex .mathtt{font-family:KaTeX_Typewriter}.katex .mathscr,.katex .textscr{font-family:KaTeX_Script}.katex .mathsf,.katex .textsf{font-family:KaTeX_SansSerif}.katex .mathboldsf,.katex .textboldsf{font-family:KaTeX_SansSerif;font-weight:700}.katex .mathitsf,.katex .mathsfit,.katex .textitsf{font-family:KaTeX_SansSerif;font-style:italic}.katex .mainrm{font-family:KaTeX_Main;font-style:normal}.katex .vlist-t{border-collapse:collapse;display:inline-table;table-layout:fixed}.katex .vlist-r{display:table-row}.katex .vlist{display:table-cell;position:relative;vertical-align:bottom}.katex .vlist>span{display:block;height:0;position:relative}.katex .vlist>span>span{display:inline-block}.katex .vlist>span>.pstrut{overflow:hidden;width:0}.katex .vlist-t2{margin-right:-2px}.katex .vlist-s{display:table-cell;font-size:1px;min-width:2px;vertical-align:bottom;width:2px}.katex .vbox{align-items:baseline;display:inline-flex;flex-direction:column}.katex .hbox{width:100%}.katex .hbox,.katex .thinbox{display:inline-flex;flex-direction:row}.katex .thinbox{max-width:0;width:0}.katex .msupsub{text-align:left}.katex .mfrac>span>span{text-align:center}.katex .mfrac .frac-line{border-bottom-style:solid;display:inline-block;width:100%}.katex .hdashline,.katex .hline,.katex .mfrac .frac-line,.katex .overline .overline-line,.katex .rule,.katex .underline .underline-line{min-height:1px}.katex .mspace{display:inline-block}.katex .smash{display:inline;line-height:0}.katex .clap,.katex .llap,.katex .rlap{position:relative;width:0}.katex .clap>.inner,.katex .llap>.inner,.katex .rlap>.inner{position:absolute}.katex .clap>.fix,.katex .llap>.fix,.katex .rlap>.fix{display:inline-block}.katex .llap>.inner{right:0}.katex .clap>.inner,.katex .rlap>.inner{left:0}.katex .clap>.inner>span{margin-left:-50%;margin-right:50%}.katex .rule{border:0 solid;display:inline-block;position:relative}.katex .hline,.katex .overline .overline-line,.katex .underline .underline-line{border-bottom-style:solid;display:inline-block;width:100%}.katex .hdashline{border-bottom-style:dashed;display:inline-block;width:100%}.katex .sqrt>.root{margin-left:.2777777778em;margin-right:-.5555555556em}.katex .fontsize-ensurer.reset-size1.size1,.katex .sizing.reset-size1.size1{font-size:1em}.katex .fontsize-ensurer.reset-size1.size2,.katex .sizing.reset-size1.size2{font-size:1.2em}.katex .fontsize-ensurer.reset-size1.size3,.katex .sizing.reset-size1.size3{font-size:1.4em}.katex .fontsize-ensurer.reset-size1.size4,.katex .sizing.reset-size1.size4{font-size:1.6em}.katex .fontsize-ensurer.reset-size1.size5,.katex .sizing.reset-size1.size5{font-size:1.8em}.katex .fontsize-ensurer.reset-size1.size6,.katex .sizing.reset-size1.size6{font-size:2em}.katex .fontsize-ensurer.reset-size1.size7,.katex .sizing.reset-size1.size7{font-size:2.4em}.katex .fontsize-ensurer.reset-size1.size8,.katex .sizing.reset-size1.size8{font-size:2.88em}.katex .fontsize-ensurer.reset-size1.size9,.katex .sizing.reset-size1.size9{font-size:3.456em}.katex .fontsize-ensurer.reset-size1.size10,.katex .sizing.reset-size1.size10{font-size:4.148em}.katex .fontsize-ensurer.reset-size1.size11,.katex .sizing.reset-size1.size11{font-size:4.976em}.katex .fontsize-ensurer.reset-size2.size1,.katex .sizing.reset-size2.size1{font-size:.8333333333em}.katex .fontsize-ensurer.reset-size2.size2,.katex .sizing.reset-size2.size2{font-size:1em}.katex .fontsize-ensurer.reset-size2.size3,.katex .sizing.reset-size2.size3{font-size:1.1666666667em}.katex .fontsize-ensurer.reset-size2.size4,.katex .sizing.reset-size2.size4{font-size:1.3333333333em}.katex .fontsize-ensurer.reset-size2.size5,.katex .sizing.reset-size2.size5{font-size:1.5em}.katex .fontsize-ensurer.reset-size2.size6,.katex .sizing.reset-size2.size6{font-size:1.6666666667em}.katex .fontsize-ensurer.reset-size2.size7,.katex .sizing.reset-size2.size7{font-size:2em}.katex .fontsize-ensurer.reset-size2.size8,.katex .sizing.reset-size2.size8{font-size:2.4em}.katex .fontsize-ensurer.reset-size2.size9,.katex .sizing.reset-size2.size9{font-size:2.88em}.katex .fontsize-ensurer.reset-size2.size10,.katex .sizing.reset-size2.size10{font-size:3.4566666667em}.katex .fontsize-ensurer.reset-size2.size11,.katex .sizing.reset-size2.size11{font-size:4.1466666667em}.katex .fontsize-ensurer.reset-size3.size1,.katex .sizing.reset-size3.size1{font-size:.7142857143em}.katex .fontsize-ensurer.reset-size3.size2,.katex .sizing.reset-size3.size2{font-size:.8571428571em}.katex .fontsize-ensurer.reset-size3.size3,.katex .sizing.reset-size3.size3{font-size:1em}.katex .fontsize-ensurer.reset-size3.size4,.katex .sizing.reset-size3.size4{font-size:1.1428571429em}.katex .fontsize-ensurer.reset-size3.size5,.katex .sizing.reset-size3.size5{font-size:1.2857142857em}.katex .fontsize-ensurer.reset-size3.size6,.katex .sizing.reset-size3.size6{font-size:1.4285714286em}.katex .fontsize-ensurer.reset-size3.size7,.katex .sizing.reset-size3.size7{font-size:1.7142857143em}.katex .fontsize-ensurer.reset-size3.size8,.katex .sizing.reset-size3.size8{font-size:2.0571428571em}.katex .fontsize-ensurer.reset-size3.size9,.katex .sizing.reset-size3.size9{font-size:2.4685714286em}.katex .fontsize-ensurer.reset-size3.size10,.katex .sizing.reset-size3.size10{font-size:2.9628571429em}.katex .fontsize-ensurer.reset-size3.size11,.katex .sizing.reset-size3.size11{font-size:3.5542857143em}.katex .fontsize-ensurer.reset-size4.size1,.katex .sizing.reset-size4.size1{font-size:.625em}.katex .fontsize-ensurer.reset-size4.size2,.katex .sizing.reset-size4.size2{font-size:.75em}.katex .fontsize-ensurer.reset-size4.size3,.katex .sizing.reset-size4.size3{font-size:.875em}.katex .fontsize-ensurer.reset-size4.size4,.katex .sizing.reset-size4.size4{font-size:1em}.katex .fontsize-ensurer.reset-size4.size5,.katex .sizing.reset-size4.size5{font-size:1.125em}.katex .fontsize-ensurer.reset-size4.size6,.katex .sizing.reset-size4.size6{font-size:1.25em}.katex .fontsize-ensurer.reset-size4.size7,.katex .sizing.reset-size4.size7{font-size:1.5em}.katex .fontsize-ensurer.reset-size4.size8,.katex .sizing.reset-size4.size8{font-size:1.8em}.katex .fontsize-ensurer.reset-size4.size9,.katex .sizing.reset-size4.size9{font-size:2.16em}.katex .fontsize-ensurer.reset-size4.size10,.katex .sizing.reset-size4.size10{font-size:2.5925em}.katex .fontsize-ensurer.reset-size4.size11,.katex .sizing.reset-size4.size11{font-size:3.11em}.katex .fontsize-ensurer.reset-size5.size1,.katex .sizing.reset-size5.size1{font-size:.5555555556em}.katex .fontsize-ensurer.reset-size5.size2,.katex .sizing.reset-size5.size2{font-size:.6666666667em}.katex .fontsize-ensurer.reset-size5.size3,.katex .sizing.reset-size5.size3{font-size:.7777777778em}.katex .fontsize-ensurer.reset-size5.size4,.katex .sizing.reset-size5.size4{font-size:.8888888889em}.katex .fontsize-ensurer.reset-size5.size5,.katex .sizing.reset-size5.size5{font-size:1em}.katex .fontsize-ensurer.reset-size5.size6,.katex .sizing.reset-size5.size6{font-size:1.1111111111em}.katex .fontsize-ensurer.reset-size5.size7,.katex .sizing.reset-size5.size7{font-size:1.3333333333em}.katex .fontsize-ensurer.reset-size5.size8,.katex .sizing.reset-size5.size8{font-size:1.6em}.katex .fontsize-ensurer.reset-size5.size9,.katex .sizing.reset-size5.size9{font-size:1.92em}.katex .fontsize-ensurer.reset-size5.size10,.katex .sizing.reset-size5.size10{font-size:2.3044444444em}.katex .fontsize-ensurer.reset-size5.size11,.katex .sizing.reset-size5.size11{font-size:2.7644444444em}.katex .fontsize-ensurer.reset-size6.size1,.katex .sizing.reset-size6.size1{font-size:.5em}.katex .fontsize-ensurer.reset-size6.size2,.katex .sizing.reset-size6.size2{font-size:.6em}.katex .fontsize-ensurer.reset-size6.size3,.katex .sizing.reset-size6.size3{font-size:.7em}.katex .fontsize-ensurer.reset-size6.size4,.katex .sizing.reset-size6.size4{font-size:.8em}.katex .fontsize-ensurer.reset-size6.size5,.katex .sizing.reset-size6.size5{font-size:.9em}.katex .fontsize-ensurer.reset-size6.size6,.katex .sizing.reset-size6.size6{font-size:1em}.katex .fontsize-ensurer.reset-size6.size7,.katex .sizing.reset-size6.size7{font-size:1.2em}.katex .fontsize-ensurer.reset-size6.size8,.katex .sizing.reset-size6.size8{font-size:1.44em}.katex .fontsize-ensurer.reset-size6.size9,.katex .sizing.reset-size6.size9{font-size:1.728em}.katex .fontsize-ensurer.reset-size6.size10,.katex .sizing.reset-size6.size10{font-size:2.074em}.katex .fontsize-ensurer.reset-size6.size11,.katex .sizing.reset-size6.size11{font-size:2.488em}.katex .fontsize-ensurer.reset-size7.size1,.katex .sizing.reset-size7.size1{font-size:.4166666667em}.katex .fontsize-ensurer.reset-size7.size2,.katex .sizing.reset-size7.size2{font-size:.5em}.katex .fontsize-ensurer.reset-size7.size3,.katex .sizing.reset-size7.size3{font-size:.5833333333em}.katex .fontsize-ensurer.reset-size7.size4,.katex .sizing.reset-size7.size4{font-size:.6666666667em}.katex .fontsize-ensurer.reset-size7.size5,.katex .sizing.reset-size7.size5{font-size:.75em}.katex .fontsize-ensurer.reset-size7.size6,.katex .sizing.reset-size7.size6{font-size:.8333333333em}.katex .fontsize-ensurer.reset-size7.size7,.katex .sizing.reset-size7.size7{font-size:1em}.katex .fontsize-ensurer.reset-size7.size8,.katex .sizing.reset-size7.size8{font-size:1.2em}.katex .fontsize-ensurer.reset-size7.size9,.katex .sizing.reset-size7.size9{font-size:1.44em}.katex .fontsize-ensurer.reset-size7.size10,.katex .sizing.reset-size7.size10{font-size:1.7283333333em}.katex .fontsize-ensurer.reset-size7.size11,.katex .sizing.reset-size7.size11{font-size:2.0733333333em}.katex .fontsize-ensurer.reset-size8.size1,.katex .sizing.reset-size8.size1{font-size:.3472222222em}.katex .fontsize-ensurer.reset-size8.size2,.katex .sizing.reset-size8.size2{font-size:.4166666667em}.katex .fontsize-ensurer.reset-size8.size3,.katex .sizing.reset-size8.size3{font-size:.4861111111em}.katex .fontsize-ensurer.reset-size8.size4,.katex .sizing.reset-size8.size4{font-size:.5555555556em}.katex .fontsize-ensurer.reset-size8.size5,.katex .sizing.reset-size8.size5{font-size:.625em}.katex .fontsize-ensurer.reset-size8.size6,.katex .sizing.reset-size8.size6{font-size:.6944444444em}.katex .fontsize-ensurer.reset-size8.size7,.katex .sizing.reset-size8.size7{font-size:.8333333333em}.katex .fontsize-ensurer.reset-size8.size8,.katex .sizing.reset-size8.size8{font-size:1em}.katex .fontsize-ensurer.reset-size8.size9,.katex .sizing.reset-size8.size9{font-size:1.2em}.katex .fontsize-ensurer.reset-size8.size10,.katex .sizing.reset-size8.size10{font-size:1.4402777778em}.katex .fontsize-ensurer.reset-size8.size11,.katex .sizing.reset-size8.size11{font-size:1.7277777778em}.katex .fontsize-ensurer.reset-size9.size1,.katex .sizing.reset-size9.size1{font-size:.2893518519em}.katex .fontsize-ensurer.reset-size9.size2,.katex .sizing.reset-size9.size2{font-size:.3472222222em}.katex .fontsize-ensurer.reset-size9.size3,.katex .sizing.reset-size9.size3{font-size:.4050925926em}.katex .fontsize-ensurer.reset-size9.size4,.katex .sizing.reset-size9.size4{font-size:.462962963em}.katex .fontsize-ensurer.reset-size9.size5,.katex .sizing.reset-size9.size5{font-size:.5208333333em}.katex .fontsize-ensurer.reset-size9.size6,.katex .sizing.reset-size9.size6{font-size:.5787037037em}.katex .fontsize-ensurer.reset-size9.size7,.katex .sizing.reset-size9.size7{font-size:.6944444444em}.katex .fontsize-ensurer.reset-size9.size8,.katex .sizing.reset-size9.size8{font-size:.8333333333em}.katex .fontsize-ensurer.reset-size9.size9,.katex .sizing.reset-size9.size9{font-size:1em}.katex .fontsize-ensurer.reset-size9.size10,.katex .sizing.reset-size9.size10{font-size:1.2002314815em}.katex .fontsize-ensurer.reset-size9.size11,.katex .sizing.reset-size9.size11{font-size:1.4398148148em}.katex .fontsize-ensurer.reset-size10.size1,.katex .sizing.reset-size10.size1{font-size:.2410800386em}.katex .fontsize-ensurer.reset-size10.size2,.katex .sizing.reset-size10.size2{font-size:.2892960463em}.katex .fontsize-ensurer.reset-size10.size3,.katex .sizing.reset-size10.size3{font-size:.337512054em}.katex .fontsize-ensurer.reset-size10.size4,.katex .sizing.reset-size10.size4{font-size:.3857280617em}.katex .fontsize-ensurer.reset-size10.size5,.katex .sizing.reset-size10.size5{font-size:.4339440694em}.katex .fontsize-ensurer.reset-size10.size6,.katex .sizing.reset-size10.size6{font-size:.4821600771em}.katex .fontsize-ensurer.reset-size10.size7,.katex .sizing.reset-size10.size7{font-size:.5785920926em}.katex .fontsize-ensurer.reset-size10.size8,.katex .sizing.reset-size10.size8{font-size:.6943105111em}.katex .fontsize-ensurer.reset-size10.size9,.katex .sizing.reset-size10.size9{font-size:.8331726133em}.katex .fontsize-ensurer.reset-size10.size10,.katex .sizing.reset-size10.size10{font-size:1em}.katex .fontsize-ensurer.reset-size10.size11,.katex .sizing.reset-size10.size11{font-size:1.1996142719em}.katex .fontsize-ensurer.reset-size11.size1,.katex .sizing.reset-size11.size1{font-size:.2009646302em}.katex .fontsize-ensurer.reset-size11.size2,.katex .sizing.reset-size11.size2{font-size:.2411575563em}.katex .fontsize-ensurer.reset-size11.size3,.katex .sizing.reset-size11.size3{font-size:.2813504823em}.katex .fontsize-ensurer.reset-size11.size4,.katex .sizing.reset-size11.size4{font-size:.3215434084em}.katex .fontsize-ensurer.reset-size11.size5,.katex .sizing.reset-size11.size5{font-size:.3617363344em}.katex .fontsize-ensurer.reset-size11.size6,.katex .sizing.reset-size11.size6{font-size:.4019292605em}.katex .fontsize-ensurer.reset-size11.size7,.katex .sizing.reset-size11.size7{font-size:.4823151125em}.katex .fontsize-ensurer.reset-size11.size8,.katex .sizing.reset-size11.size8{font-size:.578778135em}.katex .fontsize-ensurer.reset-size11.size9,.katex .sizing.reset-size11.size9{font-size:.6945337621em}.katex .fontsize-ensurer.reset-size11.size10,.katex .sizing.reset-size11.size10{font-size:.8336012862em}.katex .fontsize-ensurer.reset-size11.size11,.katex .sizing.reset-size11.size11{font-size:1em}.katex .delimsizing.size1{font-family:KaTeX_Size1}.katex .delimsizing.size2{font-family:KaTeX_Size2}.katex .delimsizing.size3{font-family:KaTeX_Size3}.katex .delimsizing.size4{font-family:KaTeX_Size4}.katex .delimsizing.mult .delim-size1>span{font-family:KaTeX_Size1}.katex .delimsizing.mult .delim-size4>span{font-family:KaTeX_Size4}.katex .nulldelimiter{display:inline-block;width:.12em}.katex .delimcenter,.katex .op-symbol{position:relative}.katex .op-symbol.small-op{font-family:KaTeX_Size1}.katex .op-symbol.large-op{font-family:KaTeX_Size2}.katex .accent>.vlist-t,.katex .op-limits>.vlist-t{text-align:center}.katex .accent .accent-body{position:relative}.katex .accent .accent-body:not(.accent-full){width:0}.katex .overlay{display:block}.katex .mtable .vertical-separator{display:inline-block;min-width:1px}.katex .mtable .arraycolsep{display:inline-block}.katex .mtable .col-align-c>.vlist-t{text-align:center}.katex .mtable .col-align-l>.vlist-t{text-align:left}.katex .mtable .col-align-r>.vlist-t{text-align:right}.katex .svg-align{text-align:left}.katex svg{fill:currentColor;stroke:currentColor;display:block;height:inherit;position:absolute;width:100%}.katex svg path{stroke:none}.katex svg{fill-rule:nonzero;fill-opacity:1;stroke-width:1;stroke-linecap:butt;stroke-linejoin:miter;stroke-miterlimit:4;stroke-dasharray:none;stroke-dashoffset:0;stroke-opacity:1}.katex img{border-style:none;max-height:none;max-width:none;min-height:0;min-width:0}.katex .stretchy{display:block;overflow:hidden;position:relative;width:100%}.katex .stretchy:after,.katex .stretchy:before{content:""}.katex .hide-tail{overflow:hidden;position:relative;width:100%}.katex .halfarrow-left{left:0;overflow:hidden;position:absolute;width:50.2%}.katex .halfarrow-right{overflow:hidden;position:absolute;right:0;width:50.2%}.katex .brace-left{left:0;overflow:hidden;position:absolute;width:25.1%}.katex .brace-center{left:25%;overflow:hidden;position:absolute;width:50%}.katex .brace-right{overflow:hidden;position:absolute;right:0;width:25.1%}.katex .x-arrow-pad{padding:0 .5em}.katex .cd-arrow-pad{padding:0 .55556em 0 .27778em}.katex .mover,.katex .munder,.katex .x-arrow{text-align:center}.katex .boxpad{padding:0 .3em}.katex .fbox,.katex .fcolorbox{border:.04em solid;box-sizing:border-box}.katex .cancel-pad{padding:0 .2em}.katex .cancel-lap{margin-left:-.2em;margin-right:-.2em}.katex .sout{border-bottom-style:solid;border-bottom-width:.08em}.katex .angl{border-right:.049em solid;border-top:.049em solid;box-sizing:border-box;margin-right:.03889em}.katex .anglpad{padding:0 .03889em}.katex .eqn-num:before{content:"(" counter(katexEqnNo) ")";counter-increment:katexEqnNo}.katex .mml-eqn-num:before{content:"(" counter(mmlEqnNo) ")";counter-increment:mmlEqnNo}.katex .mtr-glue{width:50%}.katex .cd-vert-arrow{display:inline-block;position:relative}.katex .cd-label-left{display:inline-block;position:absolute;right:calc(50% + .3em);text-align:left}.katex .cd-label-right{display:inline-block;left:calc(50% + .3em);position:absolute;text-align:right}.katex-display{display:block;margin:1em 0;text-align:center}.katex-display>.katex{display:block;text-align:center;white-space:nowrap}.katex-display>.katex>.katex-html{display:block;position:relative}.katex-display>.katex>.katex-html>.tag{position:absolute;right:0}.katex-display.leqno>.katex>.katex-html>.tag{left:0;right:auto}.katex-display.fleqn>.katex{padding-left:2em;text-align:left}body{counter-reset:katexEqnNo mmlEqnNo}';function c(e){return String(e??"").replace(/&/g,"&amp;").replace(/</g,"&lt;").replace(/>/g,"&gt;").replace(/"/g,"&quot;").replace(/'/g,"&#39;")}function ue(){return pe.replace(/url\(\/assets\/(KaTeX_[A-Za-z0-9_-]+)-[A-Za-z0-9_-]+\.(woff2|woff|ttf)\)/g,"url(https://cdn.jsdelivr.net/npm/katex@0.16.11/dist/fonts/$1.$2)")}const be=["重点难点解析","典型例题精讲"];function W(e,s,t){const a=e.课堂讲义,n=e.课后作业.reduce((z,d)=>z+d.questions.length,0),o=e.备课方案||"",i=o.match(/课时(?:安排)?[：:]\s*(\d+)\s*课时/)||o.match(/(\d+)\s*课时/),r=i?i[1]:"—",f=[...(a.核心知识点||"").matchAll(/\*\*(一|二|三|四|五|六|七|八|九|十)、([^*]+?)\*\*/g)].map(z=>`${z[1]}、${z[2].trim()}`),x=f.length?`<div class="board"><div class="board-title">${c(e.chapter)}</div>${f.map(z=>`<div class="board-item">${c(z)}</div>`).join("")}</div>
      <p class="wm-note">板书为自动生成参考骨架，教师可按课堂实际增删。</p>`:'<p class="wm-note">板书设计参考：围绕本节核心概念，建议板书「课题 + 核心概念 + 典型例题结构」。</p>',m=e.课后作业.map((z,d)=>s&&d>0?`
    ...
    <section class="hw-group">
      ...
      ${z.questions.map((_,Y)=>`
        <div class="hw-item">
          <p class="hw-q">${Y+1}. ${U(_.q)}</p>
          ${!s&&_.a?`<p class="hw-a">【参考答案】${U(_.a)}</p>`:""}
        </div>`).join("")}
    </section>`).join(""),L=t!==void 0?`<h2 class="sec-title" id="${t}">${c(e.chapter)} · 教案</h2>`:`<h1>${c(e.chapter)}</h1>`,b=z=>{const d=a[z];return!d||!d.trim()?"":s&&be.includes(z)?`
      <div class="locked-note">${c(z)}为会员专享内容，开通会员后可导出完整版。</div>`:`
      <div class="md">${u(d)}</div>`};return`
${L}
...
<h2>七、课后反馈</h2>
${s?'<p class="wm-note">课后反馈为会员专享内容，开通会员后可导出完整版。</p>':`<div class="md">${u(e.课后反馈)}</div>`}`}function B(e,s,t){return`<!DOCTYPE html>
<html lang="zh-CN">
<head>
<meta charset="UTF-8">
...
<body>
${s}
<footer>由「教师备课助手」生成 · 发布人：${P.name} · 微信：${P.wechat} · 数据来源于教案知识库</footer>
${t?`<div class="wm">${ze}</div>`:""}
</body>
</html>`}function We(e,s){const t=W(e,s);return B(`${e.stage}${e.grade}${e.subject}《${e.chapter}》备课资料`,t,s)}function Ge(e,s,t){const a=`<div class="toc">
...
`)}`;return B(t,n,s)}function Ve(e){const s=e.map(({lesson:a,index:n})=>`
<tr>
...
**八、说教学反思与效果预测**
通过这样的设计，我预计课堂上有三个比较理想的效果：一是通过情节图和表格的双支架，学生能比较完整地按顺序复述故事，减少情节遗漏；二是通过"引—析—结"的品读方法，学生能体会到诸葛亮的知天文、晓地理、识人心，而不是简单地喊"聪明"；三是通过人物对比，学生对周瑜长叹背后的心理会有更真切的体会。当然，教学中也有一些需要注意的地方，比如学生受影视剧影响可能提出课文里没有的情节，我要及时引导他们回到文本；讲述故事的时间比较紧，个别学生可能讲不完，我可以让同桌互相补充，把完整的讲述放到课后。总的来说，这节课以梳理为基、以品读为魂、以讲述为用，力求让学生在古典名著中感受人物的风采，爱上《三国演义》。我的说课到此结束，谢谢大家！`}},ds={"小学|五年级|语文|古诗三首：四时田园杂兴/稚子弄冰/村晚":{plan:`**教学基本信息**
...
我对本课效果的预期是：孩子们通过摆圆片、编口诀、对口令，能够真正理解"几个几相加可以用乘法"，记住 2-6 的 21 句口诀，并会用口诀求积。当然，口诀的熟练运用不是一节课就能完成的，需要在今后的每一节课前坚持三分钟对口令，把口诀变成自动化的反应。个别孩子在从加法到乘法的抽象上可能还需要时间，我会允许他们借助圆片摆一摆、数一数，逐步过渡。我相信，只要孩子理解了乘法的意义，口诀就再也不是枯燥的背诵，而是他们解决生活问题的好帮手。我的说课到此结束，谢谢大家！`}},us={"小学|三年级|数学|分数的初步认识":{plan:`**教学基本信息**
...
本课的设计有三个突出特点。第一，重视真实探究，圆周率不是直接告知，而是学生在测量中发现的，让数学规律"长"在学生手中。第二，重视思想方法，通过化曲为直、剪拼转化，让学生经历从曲线到直线的转化过程，感悟数学思想的力量。第三，重视易错点突破，针对半径平方、周长面积混淆等典型错误设计辨析练习，防患于未然。我预计大部分学生能正确运用公式计算圆的周长和面积，个别学生在已知直径求面积时可能忘记先求半径，我会通过规范书写步骤帮助学生避免。课堂是动态的，我也会根据学生的实际表现及时调整，让学生在探究中感受圆的魅力，收获成功的体验。同时，我深知圆的学习不是一节课就能完成的，周长与面积的灵活运用、组合图形的计算还需要在后续练习中不断巩固。我会把学生课堂上的表现作为后续教学的起点，帮助每一位学生建立起系统的圆的知识网络。`}},bs={"小学|一年级|语文|拼音：声母":{plan:`**教学基本信息**
...
我的说课到此结束，谢谢大家！`}},gs={"小学|五年级|语文|古诗：己亥杂诗":{plan:`**教学基本信息**
...
我的说课到此结束，谢谢大家！`}},ys={"小学|三年级|语文|习作：续写故事":{plan:`**教学基本信息**
课题：习作：续写故事
教材版本：统编版小学语文三年级上册
年级：小学三年级
课型：习作指导课
...
八、说教学反思
这节课我最看重的是"真实"二字。选材时坚持回忆检索，宁可让学生换题，也不让他写空话；写作时用对比片段让学生自己发现具体与空洞的差别；评改时用简单的星级表，先自评圈问题、再互评提建议，保证每个孩子都能当堂改起来。预设的困难是学生可能把小事写平，我会用"放大细节"的追问帮他把动作、语言、心理写具体。我还预设了学生补题雷同的情况，准备了备用素材，引导孩子从不同角度挖掘自己独有的美好。如果时间紧张，我会合并结尾点评，但练写环节的时间绝不压缩，因为只有动笔，方法才真正属于学生。同时我也提醒自己，公开课上要给学生留足安静写作的时间，热闹的讨论代替不了笔尖的思考。最后，愿每一个孩子都能在写作中，发现生活里被忽略的美好。我的说课到此结束，谢谢各位老师。`}},hs={"小学|一年级|数学|认识人民币":{plan:`**教学基本信息**
...
这节课以操作和体验为主线，预计学生参与度高，对面积概念的理解会比较扎实。数方格和选单位这两个活动目标明确，容易达成；面积与周长的区分可能还有个别学生混淆，我会在练习中通过围一圈还是占地方的追问重点辨析。对基础较弱的学生，只要求理解面积含义、会用数方格比较，单位换算只练整百数；对学有余力的学生，鼓励他们用同样多的方格画出不同形状的图形，感受面积与形状的关系。课后通过估一估家里物体表面的面积单位，让课堂知识延伸到生活。我相信孩子们会带着直观的感知，顺利迈出认识面积的第一步。这节课也让我深切体会到，几何概念的教学离不开亲身体验。我的说课到此结束，谢谢大家！`}},As={"小学|三年级|数学|年 月 日":{plan:`**教学基本信息**
...
我的说课到此结束，恳请各位老师批评指正，谢谢大家！`}},vs={"小学|二年级|数学|表内乘法（二）：7-9 的乘法口诀":{plan:`**教学基本信息**
课题：表内乘法（二）：7-9 的乘法口诀
教材版本：人教版小学数学二年级上册
年级：小学二年级
课型：新授课（数与代数领域）
...
**八、说教学反思与效果预测**
通过本课，预计学生能建立初步的 1 克、1 千克表象，会进行简单的换算和估计。当然，量感不是一节课就能完全形成的，估计还会有偏差，我会通过家庭称量作业和后续练习持续培养。课堂上学生掂得兴奋、称得起劲，教师要把控好秩序和时间，把热闹转化为有效的体验，让每个孩子都真正掂过、称过、想过。让"克"和"千克"在孩子们的手心里活起来，是我这节课最大的追求。总之，质量单位的教学离不开"体验"二字，我会在课堂中充分尊重学生的感官经验，把每一个抽象的概念都变成一次可触摸、可感受的操作，让量感教育真正落地生根。我的说课完毕，恳请各位老师批评指正，谢谢大家！`}},Bs={"小学|二年级|数学|时分秒":{plan:`**教学基本信息**
...
作为公开课，本节课力求让学生"知其然更知其所以然"，在扎实的计算训练中不失数学思维的味道，让计算教学既有温度、又有深度，愿数学的智慧之树在学生心中常青。`}},Ls={"小学|四年级|数学|大数的认识":{plan:`**教学基本信息**
...
**八、说教学反思与效果预测**
通过这堂课，我预计大部分学生能准确表示相反意义的量，会用数轴求相反数和绝对值，能正确进行有理数混合运算，并能用科学记数法表示简单的大数与小数。课堂上可能出现的生成问题是：学生在异号相加时仍会符号判错，或在绝对值化简时把“负a”误认为负数，我会把这些典型错误当作即时教学资源，用数轴距离当场纠偏。不足之处在于，45 分钟容量较大，若学生讨论热烈，综合练习时间可能被压缩，我会灵活精简提高作业的讲解，把更多时间留给运算巩固。相信在数形结合与分层训练的支撑下，学生能扎实迈好初中代数第一步。此外，我会特别关注学困生在符号规则上的反复，安排课后同伴互助与针对性补偿练习，确保人人过关、不留夹生饭。我的说课完毕，恳请各位老师批评指正，谢谢大家！`}},Es={"初中|七年级|数学|一元一次方程":{plan:`**教学基本信息**
...
**八、说教学反思与效果预测**
通过本课，我预计大部分学生能准确说出五种判定、规范书写简单证明，并在位置变换中找准对应。课堂生成方面，学生可能在 SAS 中误用「边边角」、在找对应时张冠李戴，这些正是宝贵资源，我会用反例（如给出两边及非夹角构造出两个不全等三角形）当场澄清。不足在于：一课时容量大，辅助线部分只能点到为止，我会把它作为后续课时的铺垫而非本节课的硬性要求；同时实验环节的时间把控、学生剪贴的课堂秩序，都需要我灵活调控。相信在实验与论证的结合中，学生能真正迈过「论证几何」的第一道门，也为后续四边形、相似等内容的学习打下扎实根基。我也清醒地认识到，公开课的真实生成往往超出预设，我会把学生的每一处疑惑都当作教学的契机，而不是匆匆带过，唯有如此，课堂才能真正属于学生，证明的教学也才能真正走进学生心里。我的说课完毕，谢谢各位老师！`}},Cs={"初中|八年级|数学|一次函数":{plan:`**教学基本信息**
课题：一次函数
教材版本：人教版初中数学八年级下册
年级：初中八年级
...
教学反思：朗读指导可更充分，部分长句节奏与重音未及细化；比较阅读宜前置，以更鲜明地凸显不同写景散文的风格差异；当堂仿写时间需更宽裕，并给后进生提供句式与词语支架以降低坡度；多感官等规律结论宜由学生自主提炼，教师“给得过多”会削弱探究味。效果预测：借助清晰支架，学生能独立赏析语言、当堂产出写景片段，审美与表达能力得以提升；分层作业照顾个体差异，绝大多数学生能达成教学目标，实现工具性与人文性的统一，让语文课既见言语之美，更见生命之春。`}},Ns={"初中|七年级|语文|课文：济南的冬天":{plan:`课题：老舍《济南的冬天》（部编版七年级上册第一单元）
...
预设反思有五：情境导入有效但部分学生拘谨，需更充分预热；动词链分解是亮点但朗读时长待加强，应让读中悟更充分；反语理解需支架式提问，降低认知坡度；情感迁移口头表达略仓促，可增设同桌互诉；板书生成应更多交给学生，增强主体性。效果预测：通过慢镜头细读，学生能准确赏析动词并说出父爱之深；借助双线梳理，能清晰把握结构与线索；背景补充将帮助难点突破；情感联结环节将唤起多数学生对亲情的真切体悟，实现语言学习与生命教育的统一，达成公开课以文化人、以情育人的目标，让学生在读懂背影的同时，也学会读懂自己的父亲。`}},Os={"初中|九年级|语文|课文：故乡":{plan:`一、导入，走近鲁迅笔下的故乡（约六分钟）
...
八、说教学反思与效果预测
预设效果：学生在对比与朗读中能准确把握形象与主题，多数能独立概括闰土变化及根源，对路的哲理形成基本理解，并能在生活中初步迁移运用。同时，我预判部分学生可能对路的象征义理解偏浅，故在设计中预留了联系生活的迁移环节，以保底促优。反思改进：一需补充历史史料，化解时代隔阂；二须给老爷细节留足体验时间；三须明示杨二嫂的对照价值，避免其被忽视；四宜将走好自己的路落地育人。力争让经典在少年心中真正生根，使公开课既有语文味，又有思想力，实现工具性与人文性的统一，达成润物无声的育人境界。`}},Rs={"初中|九年级|语文|文言文：岳阳楼记":{plan:`一、导入新课，走近范仲淹与“记”体裁
...
八、说教学反思与效果预测
反思：其一，诵读环节应更精细，可增划停顿线的个别训练；其二，词句疏通宜前置预学，把更多时间留给警句品读；其三，拓展环节时间需留足，让“古为今用”充分展开。效果预测：通过层层诵读与对比探究，学生能准确积累文言词语、流畅背诵名句，并真正理解“先忧后乐”不是空话，而是把个人荣辱置于天下之后的担当。预计多数学生能完成基础与提高层作业，部分学生能在拓展层联系抗疫、扶贫等当代事例，实现文化传承与立德树人的统一。`}},Ms={"高中|高一|数学|集合与常用逻辑用语":{plan:`**教学基本信息**
课题：集合与常用逻辑用语
教材：人教版高中数学必修第一册第一章
课型：新授课（单元整合公开课）
课时：一课时（四十五分钟）
...
**八、说教学反思与效果预测**
通过本课，我预计大部分学生能准确判断元素与集合关系，会用两种表示法刻画集合，能正确进行交并补运算，并能借助集合包含关系判断充分必要条件。课堂可能的生成问题是：学生在描述法代表元素上写错，或在充分必要条件方向颠倒，我会把这些典型错误当堂变成教学资源，用 Venn 图当场纠偏。不足之处在于四十五分钟容量较大，若学生讨论热烈，运算环节时间可能被压缩，我会灵活精简例题，把更多时间留给逻辑用语的探究。相信在情境支撑、数形结合与分层训练的保障下，学生能扎实迈好高中数学抽象思维第一步。我的说课完毕，恳请各位老师批评指正，谢谢大家！`}},Us={"高中|高一|数学|函数的概念与性质":{plan:`**教学基本信息**
...
**八、说教学反思与效果预测**
预计多数学生能说出两类函数定义与性质，会用单调性比较大小，理解互为反函数与图像对称，并体会指数对数的互逆。课堂可能生成的问题是：学生易把指数函数的变量位置与幂函数混淆，或把对数恒等式记反、忽略真数大于零，我会用即时练习当堂纠偏，并把典型错误转化为教学资源。不足在于容量大，若讨论热烈，第四环节可能被压缩，我会灵活精简拓展作业的讲解，保证反函数这一难点的充分展开。相信在情境、反例与数形结合的支撑下，学生能扎实建立指数与对数的互逆观念，为后续函数学习筑牢根基。我的说课到此结束，谢谢各位老师！`}},Ks={"高中|高一|数学|三角函数":{plan:`一、情境引入（周期现象：潮汐、圆周运动）
...
八、说教学反思与效果预测
教学反思：情境引入有效但易混概念仍需强化训练；动态演示对法则理解帮助显著，应推广到减法与数乘；数量积的几何意义是难点，须补充投影实例。效果预测：预计百分之八十以上的学生能独立完成基础运算，约百分之六十能灵活运用坐标判定平行与垂直；通过分层作业与及时反馈，不同层次学生均能获得相应发展，直观想象与数学运算素养得到有效提升，达成公开课既定的素养目标。若实际授课中发现学生对投影理解吃力，将临时增插一个"手电筒斜射地面"的生活类比，把抽象的投影具象化，体现教师对课堂的生成性调控能力，也彰显公开课应有的教学机智。`}},Hs={"高中|高一|数学|数列":{plan:`**教学基本信息**
课题：数列（概念、等差数列与等比数列）
...
**八、说教学反思与效果预测**
本课预计绝大多数学生能准确表述数列的定义，熟练使用等差与等比两类公式解决基础问题，多数学生能独立完成由 Sₙ 求 aₙ 并检验首项，半数学生能模仿完成一道错位相减求和。可能出现的生成性问题有：学生在裂项时系数配错，在错位相减最后一步化简出错，对等比中项漏掉负值；我会把这些典型错误即时转化为教学资源，让学生互评互纠。本课的不足在于四十五分钟容量偏大，若探究环节讨论热烈，方法梳理的时间会被压缩，我将灵活精简例题，把裂项相消的深入训练移至下节课。总体而言，在情境支撑、类比探究与分层训练的保障下，学生能够建立起数列知识的整体结构，实现从会算到会想的提升。我的说课完毕，恳请各位老师批评指正，谢谢大家！`}},Ds={"高中|高一|数学|不等式":{plan:`**教学基本信息**
课题：不等式
教材版本：人教版高中数学必修第一册
课型：新授课（章起始整合公开课）
课时：一课时（四十五分钟）
...
效果预测方面，通过课堂观察与学案反馈，预计百分之八十五以上的学生能够准确复述椭圆定义并自主写出两种标准方程，百分之七十以上的学生能独立完成简单的待定系数法求方程问题，约六成学生能正确解释离心率的几何意义。在素养层面，学生应能感受到概念因需要而生的数学发生观，初步形成用坐标法研究未知曲线的迁移能力，为后续双曲线与抛物线的学习奠定方法与信心上的双重基础。`}},Ws={"高中|高三|数学|概率与统计":{plan:`《概率与统计——用数据说话，用概率决策》公开课教案（高三一轮复习第一课时）
...
效果预测方面，通过课堂观察与学案反馈，预计百分之九十以上的学生能正确选择抽样方法并完成分层抽样的计算与检验，百分之八十以上的学生能说清面积等于频率的缘由并正确求解直方图中的三个数字特征，约七成学生能规范写出分布列并正确计算期望与方差，六成左右的学生能独立识别二项分布模型。在素养层面，学生应初步形成面对数据先问怎么来的、面对差距先问是否偶然的思维习惯，能用统计与概率的语言解释生活中的随机现象，为二轮复习中的统计推断与综合应用打下坚实的方法与信心基础。`}};export{Be as $,ys as A,gs as B,bs as C,us as D,ps as E,ds as F,ks as G,zs as H,$e as I,es as J,rs as K,ts as L,ss as M,as as N,Ws as O,P,ns as Q,is as R,os as S,ve as T,Ce as U,_e as V,ls as W,ye as X,Se as Y,Le as Z,se as _,$s as a,te as a0,Ve as a1,Je as a2,Ze as a3,Ke as a4,me as a5,Oe as a6,Ge as a7,Ie as a8,He as a9,Xe as aa,U as ab,De as ac,qe as ad,Fe as ae,Me as af,We as ag,Re as ah,Ye as ai,ce as aj,Pe as ak,Ne as al,re as am,xs as an,Ue as ao,j as ap,we as aq,w as ar,Te as as,je as at,Qe as au,cs as av,fs as aw,ms as ax,Ee as ay,Fs as b,Ds as c,Hs as d,Is as e,Ks as f,Xs as g,Us as h,Ms as i,Rs as j,Os as k,js as l,Ns as m,qs as n,Ps as o,Cs as p,Ts as q,Es as r,ws as s,_s as t,Ls as u,Bs as v,vs as w,Ss as x,As as y,hs as z};
